                    ...
                    <div class="panel-heading scorecard-custom-heading">
                        ...
                        <h2 class="heading">
                            ...
                            <div class="col-md-5 pull-right">
                                <form method="get" id="reportbutton" action="{{ url('report/currentYearChiefScorecard') }}" target="_blank">
                        ...
                        <div class="table-responsive" id="tabledata">
                            <table class="table table-bordered">
                                ...
                                <tr ng-repeat='chief_target in chief_targets|filter:search'>
                                    ...
                                    <td>
                                        <% chief_target.chief_measure.chief_objective.ChiefObjectiveName %>  
                                    </td>
                                    <td colspan="2">
                                        <% chief_target.chief_measure.ChiefMeasureName %><br />
                                        <i style="font-size:10px;">Contributory/ies to this Measure</i><br />
                                        <p style="display: inline" class="scorecard-minilabel" ng-repeat='staff_measure in chief_target.chief_measure.staff_measures'>
                                            <span class="label label-info">
                                                <% staff_measure.staff_accomplishments[0].staff.StaffAbbreviation %>
                                            </span>
                                        </p>
                                    </td>
                                    ...
                                    <td>
                                        <center>
                                            <textarea rows="5" cols="27" id="id_owner<%chief_target.ChiefTargetID%>" name="monthlyform"  value="<% chief_target.chief_owner.ChiefOwnerContent %>" ng-model="chief_target.chief_owner.ChiefOwnerContent" autocomplete="off"  required ng-touched></textarea>
                                        </center>
                                    </td>
                                                        ...
                                                        <form name="frmEditTarget" class="form-horizontal" novalidate="">
                                                            <div ng-repeat='staff_measure in chief_target.chief_measure.staff_measures'>
                                                                <input type="hidden" ng-init="january=staff_measure.staff_accomplishments[0].JanuaryAccomplishment">
                                                                    <div ng-if="january!='0'">
                                                                        <div ng-if="   staff_measure.staff_accomplishments[0] !=null">+ <strong><% staff_measure.staff_accomplishments[0].JanuaryAccomplishment | number: 2 %></strong> <span class="label label-default"><% staff_measure.staff_accomplishments[0].staff.StaffAbbreviation %></span>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                        </form>
                                    ...
                                    <td><% chief_target.FebruaryTarget | number: 2 %>
                                        ...
                                        <div style="margin-top: 5%" ng-if="c_february != '0'">+ 
                                            <button id="jan" data-toggle="modal" 
                                                class="btn btn-xs" style="background-color: rgba(36,36,36,.5); color: white; " href="#febModal<% $index %>">
                                                <% chief_february[$index] %>
                                            </button>
                                        </div>
                                                            ...
                                                            <div ng-repeat='staff_measure in chief_target.chief_measure.staff_measures'>
                                                                <input type="hidden" ng-init="february=staff_measure.staff_accomplishments[0].FebruaryAccomplishment">
                                                                    <div ng-if="february!='0'">
                                                                        <div ng-if="staff_measure.staff_accomplishments[0] !=null">+ <strong><% staff_measure.staff_accomplishments[0].FebruaryAccomplishment | number: 2 %></strong> <span class="label label-default"><% staff_measure.staff_accomplishments[0].staff.StaffAbbreviation %></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </form>
                                    ...
                                    <td><% chief_target.NovemberTarget | number: 2 %>
                                        ...
                                        <div style="margin-top: 5%" ng-if="c_november != '0'">+ 
                                            <button id="jan" data-toggle="modal" class="btn btn-xs" style="background-color: rgba(36,36,36,.5); color: white; " href="#novModal<% $index %>"><% chief_november[$index] %>
                                            </button>
                                        </div>
                                                        ...
                                                        <form name="frmEditTarget" class="form-horizontal" novalidate="">
                                                            <div ng-repeat='staff_measure in chief_target.chief_measure.staff_measures'>
                                                                ...
                                                                <div ng-if="november!='0'">
                                                                    <div ng-if="staff_measure.staff_accomplishments[0] !=null">+ <strong><% staff_measure.staff_accomplishments[0].NovemberAccomplishment | number: 2 %></strong> <span class="label label-default"><% staff_measure.staff_accomplishments[0].staff.StaffAbbreviation %></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                    ...
                                    <td><% chief_target.DecemberTarget | number: 2 %>
                                        ...
                                        <div style="margin-top: 5%" ng-if="c_december != '0'">+ 
                                            <button id="jan" data-toggle="modal" class="btn btn-xs" style="background-color: rgba(36,36,36,.5); color: white; " href="#decModal<% $index %>"><% chief_december[$index] %>
                                            </button>
                                        </div>
                                    ...
                                    <td>
                                        <center><textarea rows="5" cols="27" id="id_initiative<%chief_target.ChiefTargetID%>" name="monthlyform" value="<% chief_target.chief_initiative.ChiefInitiativeContent %>" ng-model="chief_target.chief_initiative.ChiefInitiativeContent" autocomplete="off"  required ng-touched ></textarea></center>
                                    </td>

                                    <td><input type='text' id="id_estimate<%chief_target.ChiefTargetID%>" name="monthlyform" valid-number value="<% chief_target.chief_funding.ChiefFundingEstimate %>" ng-model="chief_target.chief_funding.ChiefFundingEstimate" autocomplete="off" class="form-control" required ng-touched /></td>

                                    <td><input type='text' id="id_actual<%chief_target.ChiefTargetID%>" name="monthlyform" valid-number value="<% chief_target.chief_funding.ChiefFundingActual %>" ng-model="chief_target.chief_funding.ChiefFundingActual" autocomplete="off" class="form-control" required ng-touched /></td>
                                    
                                    <td><% chief_target.chief_funding.ChiefFundingEstimate - chief_target.chief_funding.ChiefFundingActual | number: 2 %></td>

                                
                                    <input type="hidden" name="ChiefMeasureID" value="<%chief_target.chief_measure.ChiefMeasureID%>" id="chiefmeasure_id<%chief_target.ChiefTargetID%>" />
                                    <input type="hidden" name="ChiefID" value="<?=$chief_user->chief->ChiefID?>" ng-model="chief_target.ChiefID" id="chief_id<%chief_target.ChiefTargetID%>" />
                                    <input type="hidden" name="UserChiefID" value="<?=$chief_user->UserChiefID?>" ng-model="chief_target.UserChiefID" id="user_chief_id<%chief_target.ChiefTargetID%>">
