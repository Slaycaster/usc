...
@section('content')
    ...
    <div ng-app="unitScorecardApp" ng-controller="APIUnitActivityLogController">
        <div class="wrap">
            <div class="row">           
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <td ng-click=""><b>Action</b>
                                        <span class="glyphicon sort-icon" ng-show="" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                                    </td>
                            
                                    <td ng-click=""><b>Last Encoded By</b>
                                        <span class="glyphicon sort-icon" ng-show="" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                                    </td>
    ...
    <!-- AngularJS Application Scripts -->
    <!-- does not exist yet -->
    <script src="{{ asset('app/controllers/unit_activity_logs.js') }}"></script>
