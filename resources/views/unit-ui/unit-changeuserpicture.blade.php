                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-warning measures-custom-panel">
                            <div class="panel-heading measures-custom-heading">
                                <i class="fa fa-circle-o-notch fa-5x"></i> <h2><b>{{ $user->unit->UnitAbbreviation }} Change Picture</b></h2>   <i ng-show="loading" class="fa fa-spinner fa-spin"></i>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="custom_picture-space"></div>
                                    <div class="col-md-3">
                                        ...
                                        <input type="hidden" name="unitid" value="{{$user->UserUnitID}}">
