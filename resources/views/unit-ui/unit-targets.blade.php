                                ...
                                <tr>
                                    ...
                                    <!-- Modal (Pop up when detail button clicked) FOR MONTHLY -->
                                            <tr>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_january_target" valid-number name="monthlyform" value="<% unit_target.JanuaryTarget %>" ng-model="unit_target.JanuaryTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_april_target" valid-number name="monthlyform" value="<% unit_target.AprilTarget %>" ng-model="unit_target.AprilTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_july_target" valid-number name="monthlyform" value="<% unit_target.JulyTarget %>" ng-model="unit_target.JulyTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_october_target" valid-number name="monthlyform" value="<% unit_target.OctoberTarget %>" ng-model="unit_target.OctoberTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_february_target" valid-number name="monthlyform" value="<% unit_target.FebruaryTarget %>" ng-model="unit_target.FebruaryTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_may_target" valid-number name="monthlyform" value="<% unit_target.MayTarget %>" ng-model="unit_target.MayTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_august_target" valid-number name="monthlyform" value="<% unit_target.AugustTarget %>" ng-model="unit_target.AugustTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_november_target" valid-number name="monthlyform" value="<% unit_target.NovemberTarget %>" ng-model="unit_target.NovemberTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_march_target" valid-number name="monthlyform" value="<% unit_target.MarchTarget %>" ng-model="unit_target.MarchTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_june_target" valid-number name="monthlyform" value="<% unit_target.JuneTarget %>" ng-model="unit_target.JuneTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_september_target" valid-number name="monthlyform" value="<% unit_target.SeptemberTarget %>" ng-model="unit_target.SeptemberTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
                                                ...
                                                <td class="col-md-2">
                                                    <input type='text' id="id_december_target" valid-number name="monthlyform" value="<% unit_target.DecemberTarget %>" ng-model="unit_target.DecemberTarget" autocomplete="off" class="form-control" required ng-touched ng-change="zero()"/>
