                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr ng-repeat='secondary_unit_target in secondary_unit_targets'>
                                        ...
                                        <td><% staff_target.staff_funding.StaffFundingEstimate - staff_target.staff_funding.StaffFundingActual | number: 2 %></td>
                                         ...
                                         <input type="hidden" name="StaffID" value="<?=$user->secondary_unit->SecondaryUnitID?>" id="staff_id<%staff_target.staff_measure.StaffMeasureID%>">
                                        <input type="hidden" name="UserStaffID" value="<?=$user->UserSecondaryUnitID?>" id="user_staff_id<%staff_target.staff_measure.StaffMeasureID%>">
                                        <td>
