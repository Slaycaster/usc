...
@section('content')
    ...
    <!-- AngularJS Application Scripts -->
    <script src="{{ asset('app/controllers/tertiaryunit_dashboard.js') }}"></script>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">{{ $tertiary_measures_count }}</div>
                                        <div>Measures</div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="panel panel-warning" ng-app="unitScorecardApp" ng-controller="APITertiaryUnitAuditTrailsDashController" >
                <div class="panel-heading">
