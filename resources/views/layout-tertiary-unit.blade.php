...
<head>
    ...
    <title>Tertiary Unit Dashboard - Philippine National Police Unit Scorecard</title>
...
<body class="layout_tertiary_unit-body">
    <div id="wrapper">
        <!-- Navigation -->
            ...
            <div class="navbar-default sidebar" role="navigation" id="sidebarinfo" style="display:none;">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('unit/scorecard') }}"><i class="fa fa-table fa-fw"></i> 
                        ...
                        <li>
                            ...
                            <a href="{{ url('unit/targets') }}"><i class="fa fa-table fa-fw"></i> 
                                Set Measure Targets
                            </a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('unit/reports') }}">
                                        Tertiary Unit Scorecard Report
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('unit/analysis_reports') }}">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('unit/changechiefpicture') }}">Change Tertiary Unit Picture</a>
                                </li>
