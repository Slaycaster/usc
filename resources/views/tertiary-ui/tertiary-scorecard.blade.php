                          ...
                          <img class="img-responsive unitdashboard-custom-picabb" src="{{ asset('uploads/tertiaryunitpictures/cropped/'.''.$user->tertiary_unit->PicturePath.'') }}">
                            ...
                            <h2 class="heading scorecard-custom-heading">
                                ...
                                <div class="col-md-3 pull-right">
                                    <a href="{{ url('report/currentYearTertiaryUnitScorecard') }}" target="_blank">
                            ...
                            <div class="table-responsive tabledata" id="tabledata">
                                <table class="table table-bordered floatThead-table">
                                    ...
                                    <tr ng-repeat='tertiary_unit_target in tertiary_unit_targets|filter:search'>
                                        ...
                                        <td><center><textarea rows="5" cols="27" id="id_owner<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" value="<% tertiary_unit_target.tertiary_unit_owner.TertiaryUnitOwnerContent %>" ng-model="tertiary_unit_target.tertiary_unit_owner.TertiaryUnitOwnerContent" autocomplete="off"  ng-touched ng-change="ownerchange()"></textarea></center></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.JanuaryTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_jan<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.JanuaryAccomplishment  %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.JanuaryAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.FebruaryTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_feb<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.FebruaryAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.FebruaryAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.MarchTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_mar<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.MarchAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.MarchAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.AprilTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_apr<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.AprilAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.AprilAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.MayTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_may<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.MayAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.MayAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.JuneTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_jun<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.JuneAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.JuneAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.JulyTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_jul<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.JulyAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.JulyAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.AugustTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_aug<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.AugustAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.AugustAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.SeptemberTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_sep<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.SeptemberAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.SeptemberAccomplishment " autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.OctoberTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_oct<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.OctoberAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.OctoberAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.NovemberTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_nov<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.NovemberAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.NovemberAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>

                                        <td class="scorecard-month"><% tertiary_unit_target.DecemberTarget | number: 2 %>/<input type='text' class="scorecard-input-month" id="id_dec<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" name="monthlyform" valid-number value="<% tertiary_unit_target.tertiary_unit_accomplishment.DecemberAccomplishment %>" ng-model="tertiary_unit_target.tertiary_unit_accomplishment.DecemberAccomplishment" autocomplete="off" class="form-control" ng-touched ng-change="accompchange()"/></td>
                                        ...
                                        <input type="hidden" name="TertiaryUnitMeasureID" value="<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" id="unitmeasure_id<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" />
                                        <input type="hidden" name="TertiaryUnitID" value="<?=$user->tertiary_unit->TertiaryUnitID?>" id="unit_id<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" />
                                        <input type="hidden" name="UserTertiaryUnitID" value="<?=$user->UserTertiaryUnitID?>" id="user_unit_id<%tertiary_unit_target.tertiary_unit_measure.TertiaryUnitMeasureID%>" />
