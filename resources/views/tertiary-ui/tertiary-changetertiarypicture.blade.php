                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-warning measures-custom-panel">
                            <div class="panel-heading measures-custom-heading">
                                <i class="fa fa-circle-o-notch fa-5x"></i> <h2><b>{{ $user->tertiary_unit->TertiaryUnitAbbreviation }} Change Chief Picture</b></h2>   <i ng-show="loading" class="fa fa-spinner fa-spin"></i>
                            </div>
                            <div class="panel-body container-fluid">
                                    ...
                                    <div class="col-md-6">
                                        <center>
                                            <h4> Current Tertiary Picture:</h4>
                                            <br />
                                            <img class="img-responsive" height="300px;" width="300px;" src="{{ asset('uploads/tertiaryunitpictures/cropped/'.''.$user->tertiary_unit->PicturePath.'') }}">
                                        </center>
                                    </div>
                                <hr>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="hidden" name="tertiaryid" value="{{$user->tertiary_unit->TertiaryUnitID}}">
                                </div>
