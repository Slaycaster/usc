                ...
                @foreach($accomplishments as $accomplishment)
                   <tr style="font-family: arial;">
                        ...
                        <td>{{--FIRST QUARTER--}}
                            ...
                            <br>
                            {{ round(($accomplishment->tertiary_unit_accomplishment->JanuaryAccomplishment + $accomplishment->tertiary_unit_accomplishment->FebruaryAccomplishment + $accomplishment->tertiary_unit_accomplishment->MarchAccomplishment), 2) }}
                            <br>
                            <?php
                        ...
                        <td>{{--SECOND QUARTER--}}
                            ...
                            <br>
                            {{ round(($accomplishment->tertiary_unit_accomplishment->AprilAccomplishment + $accomplishment->tertiary_unit_accomplishment->MayAccomplishment + $accomplishment->tertiary_unit_accomplishment->JuneAccomplishment), 2) }}
                            <br>
                            <?php
                        ...
                        <td>{{--THIRD QUARTER--}}
                            ...
                            <br>
                            {{ round(($accomplishment->tertiary_unit_accomplishment->JulyAccomplishment + $accomplishment->tertiary_unit_accomplishment->AugustAccomplishment + $accomplishment->tertiary_unit_accomplishment->SeptemberAccomplishment), 2) }}
                            <br>
                            <?php
                        ...
                        <td>{{--FOURTH QUARTER--}}
                            ...
                            <br>
                            {{ round(($accomplishment->tertiary_unit_accomplishment->OctoberAccomplishment + $accomplishment->tertiary_unit_accomplishment->NovemberAccomplishment + $accomplishment->tertiary_unit_accomplishment->DecemberAccomplishment), 2) }}
                            <br>
                            <?php
